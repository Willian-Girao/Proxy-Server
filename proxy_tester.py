...
# 
pub_urls = ['http://web.mit.edu/facilities/transportation/parking/visitors/public_parking.html', 'http://www.stanford.edu/', 
               'http://www.microsoft.com/', 
	       'http://proexti.ufam.edu.br/templates/meu_template/images/logo.png',
...
def compare_url(argtuple):
     ...
     # Retrieve directly
     direct_data = get_data(host, hostport, url)
